...
class CrmAllabolagMining(models.Model):
    ...
    request_type = fields.Selection(selection=[('industry','Industry'),('lista/omsatter-mest/11','Turns over the most'),
                                               ...
                                               ('lista/ideella-foreningar/30','Non-profit Associations')],string='Request Type',required=True,default='industry')
    ...
    fields.Many2one(comodel_name='crm.lead',string="Leads",help="") # domain|context|ondelete="'set null', 'restrict', 'cascade'"|auto_join|delegate
    # ~ link_to = fields.
    corporate_form = fields.Selection(selection=[
        (('xb/EF'),('Enskild firma')),
        (('xb/AB'),('Aktiebolag')),
    ...
    industry = fields.Selection(selection=[
        ...
        ],string='Industry',required=False)
    ...
    @api.depends('corporate_form', 'no_employees','lan','industry','revenue_from','revenue_to')
